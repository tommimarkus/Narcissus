...
local DefaultValues = {
    ...
    CameraAutoZoomIn = true,                    --Auto zoom in when opening character UI (always used by AFK mode; used normally when Instant Mode is off)
    CameraInstantMode = false,                  --Use instant open/close transitions (except AFK mode, which still follows CameraAutoZoomIn)
