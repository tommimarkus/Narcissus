...
L["Instant Mode Description On"] = "When Auto Zoom In is off, disable remaining camera movement and fade transitions.";
L["Instant Mode Description Off"] = "Default behavior. Camera still adjusts and uses fade transitions when Auto Zoom In is off.";
