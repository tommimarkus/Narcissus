...
L["Instant Mode"] = "Instant Mode";
L["Instant Mode Description On"] = "Use instant UI transitions and keep the character view centered when opening Character UI. AFK mode still follows Auto Zoom In settings.";
L["Instant Mode Description Off"] = "Use normal camera movement and fade transitions when opening Character UI.";
